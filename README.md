...
Included in this repo are docker images for the main Bitcoin Cash full nodes. This includes Bitcoin ABC, Bitcoin Cash Node and Bitcoin Unlimited. A huge thanks to Adrian Macneil, and his now unmaintained original [repository](https://github.com/amacneil/docker-bitcoin), which provided the base for this repo.
